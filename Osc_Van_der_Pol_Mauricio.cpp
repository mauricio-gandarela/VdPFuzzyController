...
main()
{
	FILE *outM11, *outM12, *outM13, *outM14, *outM15, *outM16;
	
	double x, v, t, tf, mi, b, lam, csr, cst, ssr, sst, xd, vd, ad, e, de, u, stf;

	if ((outM11 = fopen("outM11.dat", "w")) == NULL)
		printf("Nao foi possivel abrir o arquivo outM11.dat!\n");
	if ((outM12 = fopen("outM12.dat", "w")) == NULL)
		printf("Nao foi possivel abrir o arquivo outM12.dat!\n");
	if ((outM13 = fopen("outM13.dat", "w")) == NULL)
		printf("Nao foi possivel abrir o arquivo outM13.dat!\n");
	if ((outM14 = fopen("outM14.dat", "w")) == NULL)
		printf("Nao foi possivel abrir o arquivo outM14.dat!\n");
    if ((outM15 = fopen("outM15.dat", "w")) == NULL)
		printf("Nao foi possivel abrir o arquivo outM15.dat!\n");
    if ((outM16 = fopen("outM16.dat", "w")) == NULL)
		printf("Nao foi possivel abrir o arquivo outM16.dat!\n");        	
	...
	while (t < tf) {
        ...
        while (t < stf) {
            ...
            fprintf(outM11, "%.5e %.5e\n", t, x);
            fprintf(outM12, "%.5e %.5e\n", t, xd);
		    fprintf(outM13, "%.5e %.5e\n", e, de);
		    fprintf(outM14, "%.5e %.5e\n", t, u);
		    fprintf(outM15, "%.5e %.5e\n", x, v);
		    fprintf(outM16, "%.5e %.5e\n", xd, vd);
            t += sst;
		}
    }
